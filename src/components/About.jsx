        ...
        <section id="about" className="about">
            ...
            <div className="about__content">
                ...
                <div className="about__text">
                    ...
                    <p>Mi enfoque principal radica en la arquitectura de sistemas backend, donde me especializo en el diseño e implementación de APIs RESTful de alto rendimiento, optimización de bases de datos y patrones de arquitectura escalables. Complemento estas habilidades con conocimientos sólidos en frontend utilizando React y Tailwind CSS, lo que me permite desarrollar aplicaciones completas con una visión integral del producto.</p>
